...
export const MultisigProposalStats: React.FC = () => {
  ...
  const { loading, data, error } = api.multisigProposals.useGetStats({
  ...
  return (
    <CardGroup className="grid-cols-1 sm:grid-cols-2">
      <Card>
        <CardHeader>
          <CardTitle>Total Multisig Proposals</CardTitle>
        </CardHeader>
        <CardContent>
          {success && (
      ...
      <Card>
        <CardHeader>
          <CardTitle>Recent Proposals (24H)</CardTitle>
        </CardHeader>
        <CardContent>
          {success && (
            <p className="text-2xl font-bold">
