...
export const MultisigProposalRemovedStats: React.FC = () => {
  ...
  const { loading, data, error } = api.multisigProposalRemoved.useGetStats({
  ...
  return (
    <CardGroup className="grid-cols-1 sm:grid-cols-2">
      <Card>
        <CardHeader>
          <CardTitle>Total Proposal Removed</CardTitle>
        </CardHeader>
        <CardContent>
          {success && (
      ...
      <Card>
        <CardHeader>
          <CardTitle>Recent Proposal Removed (24H)</CardTitle>
        </CardHeader>
        <CardContent>
          {success && (
            <p className="text-2xl font-bold">
